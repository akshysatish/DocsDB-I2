...
docids3 = insert('[{"name": "ryan", "age": 24, "address": {"street": "neil armstrong", "city": "WL"}}]', "myDB", "myCollection")
...
#read = readSpecific('{}','{"$and": [{"name": "ryan"},{"age":{"$gt": 20}},{"address": {"city": "WL"}}]}', "myDB", "myCollection")
#print(read)
#read = readSpecific('{}','{"$or": [{"name": "ryan"},{"address": {"city": "WL"}}]}', "myDB", "myCollection")
#print(read)
